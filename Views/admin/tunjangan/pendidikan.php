...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-primary btn-sm text-right btn-tambah-data" id="tambah_tunjangan_pendidikan">
                        <i class="icon fas fa-plus"></i>
                        Tambah Data
                    </button>
                </div>
                <div class="card-body" id="tunjangan_pendidikan">
                    <?php
                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($pegawai as $key => $value) : ?>
                                <tr class="tunjangan-pendidikan" id="<?= $value['id'] ?>">
                                    <td><?= ++$key ?></td>
                                    <td><?= $value['nama'] ?></td>
                                    <td><?= $value['nik'] ?></td>
                                    ...
                                    <td>
                                        ...
                                        <form action="/admin/tunjangan/pendidikan/<?= $value['id'] ?>" class="d-inline form_delete" method="post">
                                            <?= csrf_field() ?>
    ...
    <div class="modal fade" id="modal_tunjangan_pendidikan" data-keyboard="false" data-backdrop="static">
