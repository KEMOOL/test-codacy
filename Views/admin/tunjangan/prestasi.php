...
<div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-primary btn-sm text-right btn-tambah-data" id="tambah_tunjangan_prestasi">
                        <i class="icon fas fa-plus"></i>
                        Tambah Data
                    </button>
                </div>
                <div class="card-body" id="tunjangan_prestasi">
                    <?php
                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($pegawai as $key => $value) : ?>
                                <tr class="tunjangan-prestasi" id="<?= $value['id'] ?>">
                                    <td><?= ++$key ?></td>
                                    <td><?= $value['nama'] ?></td>
                                    <td><?= $value['nik'] ?></td>
                                    ...
                                    <td>
                                        ...
                                        <form action="/admin/tunjangan/prestasi/<?= $value['id'] ?>" class="d-inline form_delete" method="post">
                                            <?= csrf_field() ?>
    ...
    <div class="modal fade" id="modal_tunjangan_prestasi" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="icon fas fa-plus"></i> Form prestasi</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form role="form" action="/admin/prestasi/tambah" method="POST" id="form_prestasi">
                    <?= csrf_field() ?>
